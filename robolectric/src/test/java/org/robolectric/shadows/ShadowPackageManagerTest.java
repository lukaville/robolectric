...
public class ShadowPackageManagerTest {
  ...
  public void checkSignatures_same() throws Exception {
    ...
    shadowPackageManager.installPackage(newPackageInfo("second.package", new Signature("00000000")));
  ...
  public void checkSignatures_noMatch() throws Exception {
    shadowPackageManager.installPackage(newPackageInfo("first.package", new Signature("00000000")));
    shadowPackageManager.installPackage(newPackageInfo("second.package", new Signature("FFFFFFFF")));
  ...
  public void checkSignatures_noMatch_mustBeExact() throws Exception {
    shadowPackageManager.installPackage(newPackageInfo("first.package", new Signature("00000000")));
    shadowPackageManager.installPackage(newPackageInfo("second.package", new Signature("00000000"), new Signature("FFFFFFFF")));
    assertThat(packageManager.checkSignatures("first.package", "second.package")).isEqualTo(SIGNATURE_NO_MATCH);
  }
  ...
  public void setPackagesSuspended_shouldSuspendSuspendablePackagesAndReturnTheRest()
    ...
    shadowPackageManager.installPackage(createPackageInfoWithPackageName("com.suspendable.package1"));
    shadowPackageManager.installPackage(createPackageInfoWithPackageName("com.suspendable.package2"));
